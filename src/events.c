...
/*   Updated: 2020/11/05 18:47:00 by sdonya           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	check_move(&wolf->man, event, ar);
	check_move2(&wolf->man, event, ar);
	check_move3(&wolf->man, event, ar);
	check_move4(&wolf->man, event, ar);
	check_rotate(&wolf->man, event);
